...
import 'package:bpg_retail/core/toast/toast_custom.dart';
import 'package:bpg_retail/core/widgets/buttons/double_button.dart';
import 'package:bpg_retail/core/widgets/buttons/icon_btn.dart';
import 'package:bpg_retail/core/widgets/calendar_custom.dart';
          ...
          Flexible(
            child: SingleChildScrollView(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.stretch,
                children: [
                  Text('Ngày', style: AppStyle.headingBs),
                  8.height,
                  CalendarCustom(
                    isAction: false,
                    isViewBottom: false,
                  ...
                  16.height,
                  Text('Giờ', style: AppStyle.headingBs),
                  8.height,
                  CupertinoTheme(
            ...
            onConfirm: () {
              if (selectedDateTime.isBefore(DateTime.now())) {
                ToastCustom.show(
                  ...
                  svgIcon: Assets.svg.warningOutline.path,
