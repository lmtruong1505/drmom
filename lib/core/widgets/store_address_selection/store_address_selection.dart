...
class StoreAddressSelection extends StatefulWidget {
  ...
  @override
  State<StoreAddressSelection> createState() => _StoreAddressSelectionState();
}

class _StoreAddressSelectionState
    extends BaseState<StoreAddressSelection, StoreAddressSelectionCubit> {
  Widget buildTitleSelected(
    String field,
    StoreAddressSelectionState state,
    bool showDot,
    int step,
  ) {
    String dot = '';
  ...
  Widget buildStep_1() {
    bool isSelected(StoreAddressSelectionState state, int index) {
      if (state.province == null) {
        return false;
      }
    ...
    return BlocBuilder<StoreAddressSelectionCubit, StoreAddressSelectionState>(
  ...
  Widget buildPage(BuildContext context) {
    ...
    return BlocListener<StoreAddressSelectionCubit, StoreAddressSelectionState>(
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  BlocBuilder<StoreAddressSelectionCubit,
                      StoreAddressSelectionState>(
                    builder: (context, state) {
                      return Container(
                        padding: Spacing.h16,
                        width: double.infinity,
