...
import 'package:BGP_Retail/core/widgets/address_selection/address_selection.dart';
...
Widget buildFormAddress(AddressCubit bloc) {
  ...
  return Form(
    ...
    child: Column(
      ...
      children: [
        ...
        Container(
          ...
          child: BlocBuilder<AddressCubit, AddressState>(
            builder: (context, state) {
              ...
              return CustomSwitch(
                label: isDefault ? "Mặc định" : "Đặt làm mặc định",
                value: isDefault,
        ...
        BlocBuilder<AddressCubit, AddressState>(
          builder: (context, state) {
            return state.address != null && state.address!.id != null
                ? Column(
                    children: [
                      const SizedBox(
                        height: 16,
                        ...
                        child: ExtraButton(
                          ...
                          onTap: () {
                            DialogUtils.showConfirmDialog(
                              context,
                              description: "Bạn có muốn xoá địa chỉ?",
                              ontap: () {},
                            );
                          },
